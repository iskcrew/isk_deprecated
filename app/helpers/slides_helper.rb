...
module SlidesHelper
  ...
  def simple_color_select(f, color)
    f.select :color, options_for_select(simple_colors, color), {}, id: 'simple_color'
  end
  
  def simple_text_size_select(f, size)
	  f.select :text_size, options_for_select(simple_text_sizes, size),  {}, id: 'simple_text_size'
  end
  
  def simple_text_align_select(f, align)
    f.select :text_align, options_for_select(simple_aligns, align), {}, id: 'simple_text_align'
  end
